...
Automatic Annotation: Using medkit to pre-annotate prescriptions.
Manual Refinement: If the automatic output is suboptimal, data is exported to doccano.
Gold Standard Creation: Manual correction of labels and relationships in doccano to generate a "perfect" CSV dataset.
Model Optimization: Using the Gold Standard to evaluate and fine-tune the annotation algorithms.
